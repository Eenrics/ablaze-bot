...
function BetsCard({
  ...
  if (
    typeof bet === "object" &&
    "receipt_number" in bet &&
    typeof bet.receipt_number === "string"
  ) {
  ...
  if (
    ...
    "choices" in bet &&
    bet.choices &&
    typeof bet.choices == "object" &&
    "numbers" in bet.choices &&
    Array.isArray(bet.choices.numbers) &&
    bet.choices.numbers.length > 0
  ) {
  ...
  return (
    <div className=" border-t-[2px] border-white/50 flex flex-row p-2 gap-2">
      <div>
      ...
      <div className=" flex-grow">
        <div className="flex flex-col gap-2">
          ...
          <div className="grid grid-cols-2">
            <div className="text-left micro-reg text-white uppercase text-sm">
              spots
            </div>
            <div className="text-right flex flex-row justify-end gap-[1px] items-center">
              ...
              {choices.map((choice, i) => {
                return (
                  <span
                    className={`${
                      draw.includes(choice)
                        ? "bg-[#ed880e] text-white"
                        : "bg-white text-black"
                    } px-2 py-[2px] text-xs font-semibold rounded-[4px]`}
                    key={i}
                  >
                    {choice}
                  </span>
