      ...
      <AnimatePresence>
        {showBall.value && (
          <motion.div
            ...
            whileInView={{ scale: 1 }}
            exit={{ scale: 0, y: -300 }}
            className="absolute [box-shadow:_inset_-8px_2px_24px_0_rgb(0_0_0_/_1);] flex justify-center items-center mt-6 z-10 left-[8%] right-0 bg-yellow-400 rounded-full w-[85%] aspect-square"
          >
